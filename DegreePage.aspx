<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DegreePage.aspx.cs" Inherits="DegreePage" %>
...
<head>
    ...
    <style>
        ...
        * {
        ...
        display: flex;
        align-items: center;
        margin-bottom: 10px; /* Add some margin between each textbox */
    }
...
<body>
    ...
    <asp:LinkButton class="active button" ID="Button3" runat="server" OnClick="DegreeIssuanceButton_Click">
 ...
 <div class="frame">
     ...
     <div class ="container_complaint" >
         <div id="contact">
        <h3>Degree Issuance Form</h3>
        <h4>Please submit your details.</h4>

             <div class="textbox-container">

<label for="name">Name of applicant (in block letters):&nbsp;&nbsp;&nbsp;</label>
...
<asp:TextBox ID="TextBox6" runat="server" OnTextChanged="TextBox6_TextChanged"></asp:TextBox>
             ...
             <div class="textbox-container">
<label for="contact">Phone/Cell/Whatsapp #:&nbsp;&nbsp;&nbsp;</label>
<asp:TextBox ID="TextBox9" runat="server" OnTextChanged="TextBox9_TextChanged"></asp:TextBox>
</div>
             <div class="textbox-container">
<label for="bankChallan">Bank Challan No.:&nbsp;&nbsp;&nbsp;</label>
<asp:TextBox ID="TextBox10" runat="server" OnTextChanged="TextBox10_TextChanged"></asp:TextBox>
</div>

             <div class="textbox-container">
<label for="date_submitted">Submission date (YYYY-MM-DD):&nbsp;&nbsp;&nbsp;</label>
<asp:TextBox ID="TextBox11" runat="server" OnTextChanged="TextBox11_TextChanged" Placeholder="YYYY-MM-DD"></asp:TextBox>
                 </div>
<br />
             <div>
                 <asp:Button ID="Button1" runat="server" CssClass="btnSubmit" Text="Submit" Width="86px" OnClick="Button1_Click1" />
                 </div>
