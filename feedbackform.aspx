...
<body>
    ...
    <asp:LinkButton CssClass=" button" ID="Button4" runat="server" OnClick="ComplaintFormButton_Click">
    ...
    <asp:LinkButton Cssclass="active button" ID="Button7" runat="server" OnClick="FeedbackButton_Click">
